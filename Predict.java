...
public class Predict {
    ...
    public void logisticRegression(SparkSession spark) {
        ...
        Dataset<Row> testDataFrame = getDataFrame(spark, true, TESTING_DATASET).cache();
        Dataset<Row> predictionDataFrame = pipelineModel.transform(testDataFrame).cache();
        predictionDataFrame.select("features", "label", "prediction").show(5, false);
        printMertics(predictionDataFrame);
